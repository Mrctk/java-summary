...
![Synchronized的使用场景](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/synchronized的使用场景.png)
...
![SynchronizedDemo.class](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/synchronizedDemo.class.png)
...
![对象，对象监视器，同步队列和线程状态的关系](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/对象，对象监视器，同步队列和线程状态的关系.png)
...
![synchronized的happens-before关系](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/synchronized的happens-before关系.png)
...
![线程A写共享变量](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/线程A写共享变量.png)
...
![线程B读共享变量](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/线程B读共享变量.png)
...
![Mark Word存储结构](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/Mark Word存储结构.png)

如图在Mark Word会默认存放hasdcode，年龄值以及锁标志位等信息。

Java SE 1.6中，锁一共有4种状态，级别从低到高依次是：**无锁状态、偏向锁状态、轻量级锁状态和重量级锁状态**，这几个状态会随着竞争情况逐渐升级。**锁可以升级但不能降级**，意味着偏向锁升级成轻量级锁后不能降级成偏向锁。**这种锁升级却不能降级的策略，目的是为了提高获得锁和释放锁的效率**。对象的MarkWord变化为下图：

![Mark Word状态变化](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/Mark Word状态变化.png)
...
![偏向锁撤销流程](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/偏向锁撤销流程.png)
...
![偏向锁获取和撤销流程](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/偏向锁获取和撤销流程.png)
...
![轻量级锁加锁解锁以及锁膨胀](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/轻量级锁加锁解锁以及锁膨胀.png)
...
![各种锁的对比](https://raw.githubusercontent.com/JourWon/image/master/Java并发编程-并发关键字/各种锁的对比.png)
