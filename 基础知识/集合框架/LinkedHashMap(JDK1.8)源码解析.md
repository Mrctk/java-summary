...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202914275.jpg)

LinkedHashMap 在上面结构的基础上，增加了一条双向链表，使得上面的结构可以保持键值对的插入顺序。同时通过对链表进行相应的操作，实现了访问顺序相关逻辑。其结构可能如下图：

![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202903675.jpg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202851206.jpg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202834395.jpg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202820581.jpg)

根据 hash 定位到该节点属于3号桶，然后在对3号桶保存的单链表进行遍历。找到要删除的节点后，先从单链表中移除该节点。如下：

![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202809846.jpg)

然后再双向链表中移除该节点：

![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202757428.jpg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202743728.jpg)

访问后，键值为3的节点将会被移动到双向链表的最后位置，其前驱和后继也会跟着更新。访问后的结构如下：

![在这里插入图片描述](https://img-blog.csdnimg.cn/20191015202730361.jpg)
